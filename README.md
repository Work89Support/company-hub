...
- **ศูนย์ปัญหาหน้างาน Admin** — แจ้งเคส ติดตามสถานะ/ผู้รับผิดชอบ/วิธีแก้
  โดยเห็นข้อมูลตามสิทธิ์แผนกและ RLS ใน Supabase
...
รันไฟล์ `supabase/migrations/202608210005_operational_issues.sql` ใน Supabase SQL Editor
หลัง Migration 001–004 เพื่อสร้างทะเบียนปัญหาหน้างานและ RLS ข้อมูลเคสจริงจะนำเข้า
ฐานข้อมูลโดยตรง และจะไม่บันทึกไว้ในไฟล์เว็บหรือ migration ที่เผยแพร่บน GitHub Pages
