...
### กรอกกิจกรรมตรงในระบบ

Migration 020–021 เพิ่มแบบฟอร์มกิจกรรม คิวข้อมูลที่ต้องเติม และแยกสิทธิ์เจ้าของ/หัวหน้า
ดู [คู่มือการกรอกและสิทธิ์ผู้ใช้](docs/08-native-entry-and-completeness.md) ก่อนเปลี่ยนจากชีตมาใช้หน้าระบบ
