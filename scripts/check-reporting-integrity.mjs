...
fs.writeFileSync('/private/tmp/kpi-preview.html','<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>body{font-family:Tahoma,sans-serif;background:#f3f6fc;color:#1e2d48;padding:32px;line-height:1.5}.card{background:white;border:1px solid #e1e7f1;border-radius:18px;max-width:1160px;margin:auto}*{box-sizing:border-box}</style>'+[...window.document.querySelectorAll('style')].at(-1).outerHTML+'</head><body>'+preview.outerHTML+'</body></html>');
